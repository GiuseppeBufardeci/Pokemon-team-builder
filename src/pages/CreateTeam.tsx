...
function CreateTeam() {
    ...
    const draftTeamName = location.state?.draftTeamName as string | undefined
    const draftPokemons = location.state?.draftPokemons as PokemonDetails[] | undefined

    const [teamName, setTeamName] = useState(draftTeamName ?? editTeam?.name ?? '')
                                ...
                                onView={(poke) => {
                                    navigate(`/pokemon/${poke.name}`, {
                                        state: {
                                            ...
                                            draftPokemons: selectedPokemons
                                        }
                                    })
                                }}
                            />;
